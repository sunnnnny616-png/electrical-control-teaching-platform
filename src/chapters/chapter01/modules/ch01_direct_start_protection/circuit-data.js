(function installCh01DirectProtectionCircuitData(global) {
  ...
  const ports = Object.freeze([
    ...
    port("ctrl_l",430,350),port("fu2_in",460,350),port("fu2_out",550,350),
    port("sb1_in",650,350),port("sb1_out",750,350),port("hold_in",650,500),port("hold_out",750,500),port("merge",810,350),
    port("sb2_in",870,350),port("sb2_out",960,350),port("coil_a1",1030,350),port("coil_a2",1150,350),
    port("fr_nc_in",1220,350),port("fr_nc_out",1300,350),port("ctrl_r",1340,350)
  ]);
  ...
  const wires = Object.freeze([
    ...
    wire("c01","control","ctrl_l","fu2_in",[{x:430,y:350},{x:460,y:350}],"control_supply"),wire("c02","control","fu2_out","sb1_in",[{x:550,y:350},{x:650,y:350}],"control"),
    wire("c03","control","sb1_out","merge",[{x:750,y:350},{x:810,y:350}],"control"),wire("c04","control","hold_out","merge",[{x:750,y:500},{x:810,y:500},{x:810,y:350}],"control"),
    wire("c05","control","merge","sb2_in",[{x:810,y:350},{x:870,y:350}],"control"),wire("c06","control","sb2_out","coil_a1",[{x:960,y:350},{x:1030,y:350}],"control"),
    wire("c07","control","coil_a2","fr_nc_in",[{x:1150,y:350},{x:1220,y:350}],"control"),wire("c08","control","fr_nc_out","ctrl_r",[{x:1300,y:350},{x:1340,y:350}],"control_supply"),
    wire("c09","control","sb1_in","hold_in",[{x:650,y:350},{x:650,y:500}],"control")
  ]);
  ...
  const components = Object.freeze([
    ...
    component("fu2","fu2","fuse","control","FU2","control",{x:460,y:339,width:90,height:22}),
    component("sb1","sb1","push_button","no","SB1 启动","control",{x:650,y:316,width:100,height:68}),
    component("km1_aux","km1","contactor","aux_no","KM1 自锁","control",{x:650,y:466,width:100,height:68}),
    component("sb2","sb2","push_button","nc","SB2 停止","control",{x:870,y:316,width:90,height:68}),
    component("km1_coil","km1","contactor","coil","KM1 线圈","control",{x:1030,y:292,width:120,height:116}),
    component("fr1_nc","fr1","thermal_relay","protection_nc","FR1 常闭保护","control",{x:1208,y:316,width:104,height:68})
  ]);
  ...
  platform.chapterCircuitData.ch01DirectStartProtection = Object.freeze({
    schemaVersion:"1.0",moduleId,mode:"self_hold",geometryLockId:"ch01_direct_start_protection_geometry_v2_locked",
